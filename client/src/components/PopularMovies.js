...
const PopularMovies = () => {
  ...
  useEffect(() => {
   ...
   // const apiKey = "eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiI2MzAxYTE5YjRjMzQ3NDYyZDgxMzcwODY0Mzk1ZjUzNyIsInN1YiI6IjY1MzE3ZGIxNDgxMzgyMDBmZjc3YWIzYSIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.YCq6B8yZK9aGpFyuq0Lk9pxPbejvjjbgdt1LoPEuejo";//process.env.REACT_APP_API_KEY; // Replace with API key
